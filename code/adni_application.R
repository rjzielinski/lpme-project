  ...
  lhipp_results[[patno_idx]] <- future(
    {
      ...
      for (time_idx in seq_along(time_values)) {
        ...
        tic()
        lhipp_pme_part[[1]][[time_idx]] <- pme(temp_lhipp_pt1, d = d)
        ...
        tic()
        lhipp_pme_part[[2]][[time_idx]] <- pme(temp_lhipp_pt2, d = d)
  ...
  rhipp_results[[patno_idx]] <- future(
    {
      ...
      for (time_idx in seq_along(time_values)) {
        ...
        tic()
        rhipp_pme_part[[1]][[time_idx]] <- pme(temp_rhipp_pt1, d = d)
        ...
        tic()
        rhipp_pme_part[[2]][[time_idx]] <- pme(temp_rhipp_pt2, d = d)
  ...
  lthal_results[[patno_idx]] <- future(
    {
      ...
      for (time_idx in seq_along(time_values)) {
        ...
        tic()
        lthal_pme_part[[1]][[time_idx]] <- pme(temp_lthal_pt1, d = d)
        ...
        tic()
        lthal_pme_part[[2]][[time_idx]] <- pme(temp_lthal_pt2, d = d)
  ...
  rthal_results[[patno_idx]] <- future(
    {
      ...
      for (time_idx in seq_along(time_values)) {
        ...
        tic()
        rthal_pme_part[[1]][[time_idx]] <- pme(temp_rthal_pt1, d = d)
        ...
        tic()
        rthal_pme_part[[2]][[time_idx]] <- pme(temp_rthal_pt2, d = d)
