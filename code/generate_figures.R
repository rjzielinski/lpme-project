...
#sim_example_case1 <- readRDS("output/simulations/case1/duration_1_interval_025_obs_noise_025_amplitude_noise_025_period_noise_010_time_trend_linear_time_change_025.RDS")
sim_example_case1 <- readRDS(
  "output/simulations/case1/duration_1_interval_025_obs_noise_010_amplitude_noise_050_period_noise_005_time_trend_quadratic_time_change_000.RDS"
)
sim_example_case5 <- readRDS(
  "simulations/case6/duration_01_interval_010_ampnoise_005_pernoise_000_n_1000_constant010_run_01.rds"
)
sim_example_case7 <- readRDS(
  "simulations/case7/duration_01_interval_010_ampnoise_010_pernoise_010_n_1000_constant000_run_01.rds"
)
...
case1_plot <- df_case1_plot |>
  filter(time %in% unique(df_case1$time)[c(1, 3, 5)]) |>
  ggplot() +
  geom_point(
    aes(
      x = x,
  ...
  facet_grid(rows = vars(source), cols = vars(time)) +
