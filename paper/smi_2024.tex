...
\begin{figure}[ht]
  \centering
  \subfloat[\centering Data]{\label{fig:sim_case1} \includegraphics[width=8cm]{sim_case1_plot2}}%
  \hfill
...
% \begin{figure}[ht]
%   \centering
%   \subfloat[\centering Unaugmented Unit Circle]{{\includegraphics[width=8.75cm]{unit_circle_D2}}}%
%   \hfill
%   \subfloat[\centering Augmented Unit Circle]{{\includegraphics[width=8.75cm]{unit_circle_D3}}}
