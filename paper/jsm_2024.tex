...
\begin{figure}[ht]
  \centering
  \subfloat[\centering Unaugmented Unit Circle]{{\includegraphics[height=9cm]{unit_circle_D2}}}%
  \hfill
  \subfloat[\centering Augmented Unit Circle]{{\includegraphics[height=9cm]{unit_circle_D3}}}
...
\begin{figure}[h]
  \centering
  \subfloat[\centering Left Hippocampus Cross Section]{\includegraphics[height=10cm]{results/adni_plots/adni_cross_section}}%
  \hfill
  \subfloat[\centering Estimated Volumes]{\includegraphics[height=10cm]{}}
  \includegraphics[height=10cm]{adni_plots/adni_cross_section}
...
\begin{figure}[h]
    \centering
    \includegraphics[height=10cm]{adni_plots/adni_lthal_cross_section.png}
