...
\subsection{A Motivating Question from the Medical Imaging}
...
\begin{figure}[h]
  ...
  \subfloat[\centering Left Hippocampus Cross Section]{{\includegraphics[height=8cm]{adni_plots/adni_cross_section}} \label{fig:lhipp_cross_sections}}%
  \vfill
...
\begin{figure}%
  \centering
  \subfloat{
      \subfloat[\centering Data]{{\includegraphics[height=12cm]{adni_plots/adni_lhipp_data_plot}}}%
      \hfill
      \subfloat[\centering LPME Estimate]{{\includegraphics[height=12cm]{adni_plots/adni_lhipp_lpme_isomap_plot}}}
      \hfill
      \subfloat[\centering PME Estimate]{{\includegraphics[height=12cm]{adni_plots/adni_lhipp_pme_plot}}}
      \label{fig:adni_result}
  }
  \hfill
  \subfloat{
      \subfloat[\centering Data]{{\includegraphics[height=12cm]{adni_plots/adni_lthal_data_plot}}}%
      \hfill
      \subfloat[\centering LPME Estimate]{{\includegraphics[height=12cm]{adni_plots/adni_lthal_lpme_Isomap_plot}}}
      \hfill
      \subfloat[\centering PME Estimate]{{\includegraphics[height=12cm]{adni_plots/adni_lthal_pme_plot}}}
