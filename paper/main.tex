...
\begin{figure}[h]
  ...
  \caption{Longitudinal Simulated Data with $D = 2$. Data from the function ADD FUNCTION are simulated at 5 time points. Random noise is added both in time and space as ADD FUNCTION.}
